...
String uid;
    ...
    public void onClick(View v) {
        ...
        if(v==btnAddToCart){
            ...
            ItemCart newItemCart=new ItemCart(currentItem,1);
            ...
            if(userCart!=null&& userCart.getItems().size()>0) {
                ...
                databaseService.updateCart(userCart, uid, new DatabaseService.DatabaseCallback<Void>() {
                    ...
                    public void onCompleted(Void object) {
                        ...
                        Toast.makeText(ItemProfile.this, userCart.getItems().size()+"המוצר נוסף לעגלה", Toast.LENGTH_SHORT).show();
